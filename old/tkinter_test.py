...
#RBG mixes
yello = (255, 255, 0)       (  0, 0, 100,   0)
magen = (255, 0,   255)     (  0, 100, 0,   0)
cyan =  (0,   255, 255)     (100, 0,   0,   0)

# half breeds
purpl = (128, 255, 0)       ( 50, 100, 0,   0)
orang = (255, 128, 0)       ( 0, 50, 100,   0)
...
def add():
    ...
    #m1, m2, m3 = [int(i) for i in text.split(",")]
    color_hex = color.hex
...
def update_root(text, var):
    ...
    if all(list_status[:-1]) == True:
        print("box verifyer") #add funcion to detect if all boxes are checked <<<---------------
    else:
        pass
    root.update()
